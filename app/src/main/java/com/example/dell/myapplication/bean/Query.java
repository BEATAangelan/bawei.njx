...
public class Query {
    ...
    public static class ResultBean {
        /**
         * commodityId : 173
         * commodityName : 新番祖 电脑包 13.3/14/15.6英寸苹果笔记本电脑包 女 手提公文包 贝壳 樱花粉-13.3英寸及以下（淑女款）
         * masterPic : http://172.17.8.100/images/small/commodity/xbsd/dnb/4/1.jpg
         * price : 119
         * saleNum : 0
         */
